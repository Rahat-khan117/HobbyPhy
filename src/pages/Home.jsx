            ...
            <div className="absolute top-[25%]  left-[10%]">
              <div>
                <p className="lx:text-6xl lg:text-4xl md:text-2xl sm:text-4xl text-xl text-white font-bold ">
                  {" "}
                  Book Club Gathering: <br /> Connect Over Stories That Inspire
                  – Join a Local Book Club Today!
                </p>
                <p className="text-white mt-2 lg:text-[16px] text-[14px] ">
                  Dive into meaningful conversations and make new <br />
                  friends who share your passion for books. Whether it's
                  fiction, <br /> nonfiction, or poetry—there's a club for every
                  reader.
                  <br />
                </p>
          ...
          <div id="slide3" className="carousel-item relative w-full">
            ...
            <div className="absolute top-[25%]  left-[10%]">
              <div>
                <p className="lx:text-6xl lg:text-4xl md:text-2xl sm:text-4xl text-xl text-white font-bold ">
                  {" "}
                  Hiking Crew Adventure <br /> Together – Find Your Hiking
                  Tribe!
                </p>
                <p className="text-white mt-2 lg:text-[16px] text-[14px] ">
                  Explore the Outdoors, One Trail at a Time.
                  <br />
                  Join a group of adventure-seekers who love fresh air, stunning
                  views, and good company. <br />
                  Whether you’re a casual walker or a trail expert, there's a
                  crew waiting for you. <br />
                </p>
                <div className="flex mt-4">
          ...
          <div id="slide4" className="carousel-item relative w-full">
            ...
            <div className="absolute top-[25%]  left-[10%]">
              <div>
                <p className="lx:text-6xl lg:text-4xl md:text-2xl sm:text-4xl text-xl text-white font-bold ">
                  {" "}
                  Art & Painting Circle <br /> Unleash Your Creativity – Paint,
                  Share, and Belong.{" "}
                </p>
                <p className="text-white mt-2 lg:text-[16px] text-[14px] ">
                  Join a creative circle where your imagination can run wild.{" "}
                  <br />
                  Whether you're a beginner or a pro, express yourself through
                  <br />
                  art in a welcoming, collaborative space.
                  <br />
                </p>
                <div className="flex mt-4">
                  <button className="text-white border-1 border-whit w-[140px] h-[45px] rounded-tl-2xl rounded-bl-2xl text-xl cursor-pointer hover:bg-white hover:text-black">
      ...
      <div className="mt-10 px-4 sm:px-7 md:px-12 lg:px-20">
        ...
        <div className="bg-white rounded-2xl px-4 py-4 mt-4">
          <img
            ...
            src="https://i.ibb.co/Hwn1XbP/7.jpg"
          />
        </div>
      </div>
    </div>
