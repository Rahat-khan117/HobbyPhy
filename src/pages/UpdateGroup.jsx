...
const UpdateGroup = () => {
  ...
  const { id } = useParams();
  const machDetails = groups.find((group) => group._id === id);
      ...
      <div className="bg-[#331a152a] mt-10 sm:px-12 px-6 py-9 rounded-3xl">
        <div>
          <p className="font-bold text-5xl text-[#331A15] text-center">
            Update your {machDetails.group_name}
          </p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="sm:flex gap-4 ">
            <div className="my-3 sm:w-[50%]">
              ...
              <input
                defaultValue={machDetails.group_name}
                name="group_name"
                type="text"
          ...
          <div className="sm:flex gap-4">
            <div className="my-3 sm:w-[50%]">
              ...
              <input
                defaultValue={machDetails.description}
                name="description"
                type="text"
            ...
            <div className="my-3 sm:w-[50%]">
              ...
              <input
                defaultValue={machDetails.meeting_location}
          ...
          <div className="sm:flex gap-4">
            <div className="my-3 sm:w-[50%]">
              ...
              <input
                defaultValue={machDetails.max_number}
                name="max_member"
                type="text"
            ...
            <div className="my-3 sm:w-[50%]">
              ...
              <input
                defaultValue={machDetails.start_date}
                name="start_date"
                type="text"
